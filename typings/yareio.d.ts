...
type RoleSoldier = 'attacker' | 'defender' | 'scout';
type RoleWorker = 'harvester' | 'linker' | 'feeder';
...
interface _Spirit extends Destructible {
	...
	type: Type;
	role: RoleSoldier | RoleWorker | undefined;
	targetStar: Star;
	state: 'charging' | 'harvesting';
